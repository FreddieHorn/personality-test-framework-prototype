...
if __name__ == "__main__":
    ...
    setup_goals("baseline_test.csv", f"output/{prefix}/baseline_test_goals.csv", client)
    ...
    # scenario_generation(step_0_csv_path, step_1_csv_path, client, mode='agentic', temperature = 3)
